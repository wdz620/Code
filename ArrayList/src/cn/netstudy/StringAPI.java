...
public class StringAPI {
    ...
    public static Character findMapMaxValue(String str) {
        ...
        System.out.println("maxkey is --->: " + maxkey + "  " + "maxvalue is ---> :" + maxvalue);   //maxkey is --->: a  maxvalue is ---> :3
        return maxkey;
    }
    ...
    public static void main(String[] args) {
        ...
        //获取一个文件名的扩展名
        System.out.println(lastName(s1));   //.java
        System.out.println(lastName(s2));   //.txt
        System.out.println();

        //查找一个字符串中子字符串出现的所有位置
        String s3 = "xxxabcxxxabcxxx";
        System.out.println(Arrays.toString(findSubIndex(s3, "abc")));   //[3, 9]
        System.out.println();

        //查找一个字符串中出现最多的字符:方法1和方法2 如果出现并列最多输出第一词出现的
        String s4 = "abcdefghijklba";
        System.out.println(findCharMost2(s4));      //b
        //查找一个字符串中出现最多的字符（Huawei）
        String s5 = "abcabcba";
        System.out.println(findMapMaxValue(s5));    //a
        System.out.println("**************************************");
        ...
        String b1 = "wdz";
        String b2 = "wdd";
        System.out.println("wdz的长度" + b1.length());
        System.out.println(b1.compareTo(b2));   //22
