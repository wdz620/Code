 ...
 *
 * 举例解释：
 * 桌子上放了红包  1, 2, 3, 4, 7, 10。小明在“4,7”之间、“7,10” 之间各切一刀，
 ...
 * 5
 * 1 3 1 1 4
 * 输出 5  说明：[1,3,1]  [ ]   [1,4] ，其中第一组奖金和是5，等于第三组奖金和。所以小明可以拿到5越南盾
 *
 * 5
 * 1 3 2 1 4
 * 输出 4  说明：[1,3]   [2,1]  [4]，小明可以拿到4越南盾
 *
 * 3
 * 4 1 2
 * 输出 0 说明：[ ]  [4, 1, 2] [ ] ，小明没办法，为了保证第一组第三组相等，只能都分成空的。所以小明只能拿到0越南盾。
 */
public class KS_01 {
    public static void main(String[] args) throws IOException {
        ...
        long leftSum = nums[left], rightSum = nums[right], maxSum = 0;
        while (left < right) {
            if (leftSum == rightSum) {
                maxSum = leftSum;
                leftSum += nums[++left];
